...
项目已建立 Tauri 2、React、TypeScript、Vite、CodeMirror 6 与 Rust 可运行工程基线。当前可新建和打开文档，也已实现严格 UTF-8/CP936 识别、二进制 IPC、前端编辑会话与已打开文件的普通保存；文件打开已完成 macOS 验收，普通保存已完成实现和自动化验证、待 macOS 交互验收。Windows 验证、另存为及后续切片尚待进行。
...
- `docs/features/save-opened-file.md`：当前已承诺的已打开文件普通保存规格
